# HANDOFF history - sections older than the current campaign

Moved verbatim from `HANDOFF.md` on 2026-09-05 (nothing edited). The live
file keeps only the current sections; `docs/history/README.md` maps every
path that moved since these were written.
